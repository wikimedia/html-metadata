...
exports.parseBEPress = BBPromise.method(function(chtml){
	...
	if (!metaTags || metaTags.length === 0) {
		return BBPromise.reject('No BE Press metadata found in page');
	}
	...
	metaTags.each(function() {
		...
		var property = nameAttr.substring(17).toLowerCase();
...
exports.parseHighwirePress = BBPromise.method(function(chtml){
	...
	if (!metaTags || metaTags.length === 0) {
		return BBPromise.reject('No Highwire Press metadata found in page');
	}
	...
	metaTags.each(function() {
		...
		var property = nameAttr.substring(nameAttr.indexOf('_') + 1).toLowerCase();
		var content = element.attr('content');
