...
exports.parseGeneral = BBPromise.method(function(chtml){
	var clutteredMeta = {
		...
		webapp: chtml('link[rel=manifest i]').first().attr('href'),
		keywords: chtml('meta[name=keywords i]').first().attr('href'),
		...
		mention: chtml('link[rel=webmention i]').first().attr('href'),
		hub: chtml('link[rel=hub i]').first().attr('href'),
		salmon: chtml('link[rel=salmon i]').first().attr('href'),
	};
