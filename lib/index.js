...
exports.parseGeneral = BBPromise.method(function(chtml){
	...
	var clutteredMeta = {
		appleTouchIcons: chtml('link[rel=apple-touch-icon i]').map(function(i, e) { return { url: e.attribs.href, size: e.attribs.sizes } }).get(), //apple-touch-icon <link rel="apple-touch-icon" href="" sizes="" type="">
		icons: chtml('link[rel="shortcut icon" i], link[rel="icon" i]').map(function(i, e) { return { url: e.attribs.href, size: e.attribs.sizes, type: e.attribs.type } }).get(), //icon <link rel="icon" href="" sizes="" type="">
