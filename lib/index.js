 ...
 */
exports.parseBase = BBPromise.method(function(
  chtml,
  tags,
  reason,
  getProperty,
  ...
  return exports.parseBase(
    ...
    function(element) {
      ...
      if (
        !name ||
        !content ||
        name.substring(0, 17).toLowerCase() !== 'bepress_citation_'
      ) {
        return;
      }
...
exports.parseCOinSTitle = BBPromise.method(function(title) {
  ...
  if (typeof title !== 'string') {
    return BBPromise.reject(
      Error('Provided value must be a string; Got ' + typeof title)
    );
  }
  ...
  if (Object.keys(rft).length) {
    // Add rft object if it is not empty
    metadata.rft = rft;
  }
...
exports.parseDublinCore = BBPromise.method(function(chtml) {
  return exports.parseBase(
    ...
    function(element) {
      ...
      var property = nameAttr
        .substring(nameAttr.lastIndexOf('.') + 1)
        .toLowerCase();
    ...
    .parseBase(
      ...
      function(element) {
        ...
        if (
          !nameAttr ||
          !content ||
          nameAttr.substring(0, 8).toLowerCase() !== 'eprints.'
        ) {
          return;
        }
...
exports.parseGeneral = BBPromise.method(function(chtml) {
  var clutteredMeta = {
    appleTouchIcons: chtml('link[rel=apple-touch-icon i]')
      .map(function(i, e) {
        return {
          href: e.attribs.href,
    ...
    icons: chtml('link[rel="shortcut icon" i], link[rel="icon" i]')
      .map(function(i, e) {
        return {
          href: e.attribs.href,
          sizes: e.attribs.sizes,
    ...
    author: chtml('meta[name=author i]')
      .first()
      .attr('content'), //author <meta name="author" content="">
    authorlink: chtml('link[rel=author i]')
      .first()
      .attr('href'), //author link <link rel="author" href="">
    canonical: chtml('link[rel=canonical i]')
      .first()
      .attr('href'), //canonical link <link rel="canonical" href="">
    description: chtml('meta[name=description i]').attr('content'), //meta description <meta name ="description" content="">
    publisher: chtml('link[rel=publisher i]')
      .first()
      .attr('href'), //publisher link <link rel="publisher" href="">
    robots: chtml('meta[name=robots i]')
      .first()
      .attr('content'), //robots <meta name ="robots" content="">
    shortlink: chtml('link[rel=shortlink i]')
      .first()
      .attr('href'), //short link <link rel="shortlink" href="">
    title: chtml('title')
      .first()
    ...
    lang:
      ...
      chtml('html')
        .first()
        .attr('xml:lang'), //lang <html lang=""> or <html xml:lang="">
    dir: chtml('html')
      .first()
      .attr('dir') //dir <html dir="">
  };
...
/**
 * Scrapes pinterest metadata terms given Cheerio loaded html object
 * @param  {Object}   chtml html Cheerio object
 * @return {Object}         BBPromise for general metadata
 */
exports.parsePinterest = BBPromise.method(function(chtml) {
  var pinterestData = {
    pinboard: chtml('meta[property="pinterestapp:pinboard"]').attr('content'), //pinterestapp:pinboard <meta property ="pinterestapp:pinboard" content="">
    pinner: chtml('meta[property="pinterestapp:pinner"]').attr('content'), //pinterestapp:pinner <meta property ="pinterestapp:pinner" content="">
    source: chtml('meta[property="pinterestapp:source"]').attr('content'), //pinterestapp:source <meta property ="pinterestapp:source" content="">
    likes: chtml('meta[property="pinterestapp:likes"]').attr('content'), //pinterestapp:likes <meta property ="pinterestapp:likes" content="">
    repins: chtml('meta[property="pinterestapp:repins"]').attr('content'), //pinterestapp:repins <meta property ="pinterestapp:repins" content="">
    comments: chtml('meta[property="pinterestapp:comments"]').attr('content'), //pinterestapp:comments <meta property ="pinterestapp:comments" content="">
    actions: chtml('meta[property="pinterestapp:actions"]').attr('content') //pinterestapp:actions <meta property ="pinterestapp:actions" content="">
  };
  ...
  var value;
  var notEmpty = false;
  Object.keys(pinterestData).forEach(function(key) {
    notEmpty = false;
    value = pinterestData[key];
    var innerValue; //used to check if the value has multiple attributes inside of it
    if (value && typeof value === 'object') {
      for (var i = 0; i < Object.keys(value).length; i++) {
        var definedValue = {};
  ...
  // Reject promise if meta is empty
  if (Object.keys(meta).length === 0) {
    throw new Error('No pinterest metadata found in page');
  }
  // Resolve on meta
  return meta;
});
  ...
  return exports.parseBase(
    ...
    function(element) {
      ...
      if (
        !nameAttr ||
        !content ||
        nameAttr.substring(0, 9).toLowerCase() !== 'citation_'
      ) {
        return;
      }
...
exports.parseOpenGraph = BBPromise.method(function(chtml) {
  ...
  metaTags.each(function() {
    ...
    if (propertyValue.length === 2) {
      ...
      if (property in subProperty) {
        // If has valid subproperty
        node = {};
...
exports.parseTwitter = BBPromise.method(function(chtml) {
  ...
  metaTags.each(function() {
    ...
    if (name.length > 2) {
      ...
      if (
        property in dualStateSubProperties &&
...
exports.metadataFunctions = {
  ...
  pinterest: exports.parsePinterest
};
